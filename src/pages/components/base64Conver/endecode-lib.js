...
let EncodeUtils = (() => {
          ...
          let r = (function (e, r) {
              ...
              for (let r = 0; r < e.length; r++) {
                ...
                0 <= o && o <= 127
                  ? ((n += 1), t.push(o))
                  : 128 <= o && o <= 2047
                    ? ((n += 2), t.push(192 | (31 & (o >> 6))), t.push(128 | (63 & o)))
                    : ((2048 <= o && o <= 55295) || (57344 <= o && o <= 65535)) &&
                      ((n += 3),
                      t.push(224 | (15 & (o >> 12))),
                      t.push(128 | (63 & (o >> 6))),
                      t.push(128 | (63 & o)))
          ...
          return (function (e) {
            ...
            for (let e = 0; e < t.length; e++) {
              ...
              if (o && 8 === n.length) {
                ...
                for (let r = 1; r < n; r++) a += t[r + e].toString(2).slice(2)
                ;((r += String.fromCharCode(parseInt(a, 2))), (e += n - 1))
              } else r += String.fromCharCode(t[e])
            }
            return r
          })(r)
        }
  ...
  return {
    uniEncode: function (e) {
      let r = []
      for (let t = 0; t < e.length; t++) r[t] = ('00' + e.charCodeAt(t).toString(16)).slice(-4)
      return '\\u' + r.join('\\u')
    },
    ...
    urlParamsDecode: function (e) {
      ...
      try {
        let t = [],
          n = new URL(e)
        for (let e of n.searchParams) t.push(e)
        r = {
          url: n.href,
          params: t,
          protocol: n.protocol,
          ...
          (function (e) {
            ...
            for (r = 0; r < e.length; r++)
              (t = e.charCodeAt(r)) < 128
                ? o.push(t)
                : t < 2048
                  ? o.push(192 + ((t >> 6) & 31), 128 + (63 & t))
                  : ((n = 55296 ^ t) >> 10 == 0
                      ? ((t = (n << 10) + (56320 ^ e.charCodeAt(++r)) + 65536),
      ...
      for (l[2] = ~l[0], l[3] = ~l[1], s = 0; s < a.length; s += 16) {
        ...
        for (r = 0; r < 80; r++)
          ((c[r] = r < 16 ? a[s + r] : u(c[r - 3] ^ c[r - 8] ^ c[r - 14] ^ c[r - 16], 1)),
            ...
            l.pop(),
            l.unshift(t))
        for (r = 0; r < 5; r++) l[r] = (l[r] + f[r]) | 0
      }
      t = new DataView(new Uint32Array(l).buffer)
      for (var s = 0; s < 5; s++) l[s] = t.getUint32(s << 2)
      return Array.prototype.map
        .call(new Uint8Array(new Uint32Array(l).buffer), function (e) {
